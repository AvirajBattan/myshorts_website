...
export const posts: Post[] = [
  ...
  },
  {
    ...
    title: "How to Turn a YouTube Video Into Instagram Reels (2026)",
    excerpt:
      "Your YouTube channel is a Reels factory you're not using. Here's how to repurpose any YouTube video into vertical, captioned Instagram Reels — no re-filming, no watermark.",
    date: "2026-08-12",
    readMins: 5,
    tag: "Playbook",
    keywords: [
    ...
    body: [
      ...
      { type: "h2", text: "Make it feel native to Instagram" },
      { type: "p", text: "A Reel that looks recycled gets scrolled past. Keep the crop tight on the speaker, keep captions short so they never cover a face, and lead with the strongest three seconds — the hook that made the moment worth clipping. Because captions are burned in, they survive re-uploads and cross-posting to TikTok and Shorts." },
      { type: "p", text: "Paste a YouTube link and turn your first moment into a Reel free — no card, no watermark." },
    ],
  },
  {
    slug: "opus-clip-alternatives-2026",
    title: "The Best Opus Clip Alternatives in 2026 (and How to Choose)",
    excerpt:
      "Opus Clip isn't the only way to turn long videos into Shorts. Here's how to compare the alternatives — on framing, watermarks, pricing, and whether they do more than clip.",
    date: "2026-08-10",
    readMins: 6,
    tag: "Guide",
    keywords: [
      ...
      "ai shorts tool comparison",
      "klap alternative",
    ],
    related: { label: "See all alternatives →", href: "/alternatives" },
    body: [
      { type: "p", text: "Opus Clip popularised the “paste a link, get Shorts” workflow, and plenty of tools now do a version of it — Klap, Vizard, Submagic, vidyo.ai, 2short.ai, Crayo and more. If you're shopping around, the real question isn't which tool has the longest feature list; it's which one gets the four things below right." },
      { type: "h2", text: "1. Does the crop keep the speaker in frame?" },
      { type: "p", text: "Turning 16:9 into 9:16 throws away most of the frame. A naive center crop slices people in half; face-aware reframing tracks the talker and keeps them centered, with modes for two-person interviews. This is the single biggest quality difference between tools." },
      { type: "h2", text: "2. Is there a watermark, and is output full HD?" },
      { type: "p", text: "Many tools stamp a watermark or cap resolution on cheaper plans, so your clips look like an ad for the tool rather than your own content. Look for full HD and watermark-free export on every tier, including the free one." },
      { type: "h2", text: "3. Does the pricing make sense for you?" },
      { type: "p", text: "Most alternatives price in dollars. If you're in India, a fair rupee price — and paying for volume rather than quality — matters more than a marginal feature. Full HD shouldn't be a paid upgrade; more monthly videos should be." },
      { type: "h2", text: "4. Does it do more than clip?" },
      { type: "p", text: "Clipping is one job. If a single YouTube link can also give you a summary, editable notes, a searchable transcript and grounded Q&A, you replace several subscriptions with one tool — and get more out of every upload." },
      { type: "p", text: "That's the checklist MyShorts is built against: face-aware 9:16, no watermark and full HD on every plan, rupee pricing from ₹499/mo, and summaries, notes, transcript and Q&A from the same link. Compare it on your own video — the first clip is free." },
    ],
  },
  {
    slug: "download-youtube-transcript",
    title: "How to Get the Transcript of Any YouTube Video (No Extension)",
    excerpt:
      "Need the text of a YouTube video to search, quote, or caption? Here's how to pull a full transcript — and export it as SRT — from just a link, no browser extension required.",
    date: "2026-08-06",
    readMins: 4,
    tag: "How-to",
    keywords: [
    ...
    related: { label: "Get a transcript →", href: "/youtube-transcript" },
    body: [
      { type: "p", text: "A transcript is the most reusable thing you can pull from a video: you can search it, quote it, translate it, or turn it into subtitles. The good news is you don't need a browser extension or a download — just the video's link." },
      { type: "h2", text: "Paste a link, get the full text" },
      { type: "p", text: "Submit the YouTube URL and the entire spoken text comes back in seconds. It works even when a video has no manual captions, falling back to auto-generated subtitles, so you're not stuck when a creator didn't add their own." },
      { type: "h2", text: "Export it the way you need it" },
      { type: "ul", items: [
      ...
      { type: "h2", text: "Then do something with it" },
      { type: "p", text: "A transcript is a starting point. From the same link you can generate a structured summary, clean editable notes, grounded Q&A that answers from the transcript, and face-aware 9:16 Shorts cut from the best moments — so you read it, search it, and act on it without copying text between five different tools." },
      { type: "p", text: "Paste a YouTube link and pull your first transcript free — no extension, no card." },
    ],
  },
];
